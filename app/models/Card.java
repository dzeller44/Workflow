...
public class Card extends Model {
	...
	public static Model.Finder<Long, Card> find = new Model.Finder<Long, Card>(Long.class, Card.class);

	public static List<Card> filterByTeam(String value) {
		return find.where().eq("team", value).findList();
	}
	
	public static List<Card> filterByPosition(String value) {
		return find.where().eq("position", value).findList();
	}

	public static Card findByUniqueKey(String uniqueKey) {
		return find.where().eq("uniquekey", uniqueKey).findUnique();
	}
	
	public static List<Card> searchAllCards(String value) {
		return find.where()
				.disjunction()
	...
	public String createUniqueKey() {
		...
		while (!isUnique) {
			Card record = Card.findByUniqueKey(uniqueKey);
			if (record != null) {
