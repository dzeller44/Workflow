 ...
 */
@Entity
public class WorkflowProfile extends Model {
	...
	public static Model.Finder<Long, WorkflowProfile> find = new Model.Finder<Long, WorkflowProfile>(Long.class, WorkflowProfile.class);

	public static List<WorkflowProfile> filterByAgency(String value) {
		return find.where().eq("appAgency", value).findList();
	}
	
	public static WorkflowProfile findByUniqueKey(String uniqueKey) {
